...
harmonizeCasters <- function(x) {
    casters <- c("Absylonia 1", "Absylonia 2", "Agathia 1", "Aiakos 2", "Amon 1", 
        "Arkadius 1", "Ashlynn 1", "Asphyxious 1", "Asphyxious 2", "Asphyxious 3", 
        ...
        "Doomshaper 3", "Dreamer 1", "Durgen 1", "Durant 2", "Durst 1", "Elara 2", 
        "Feora 1", "Feora 2", "Feora 3", 
        ...
        "Horgle 2", "Iron Mother 1", "Irusk 1", "Irusk 2", "Issyria 1", 
        "Jaga-Jaga 1", "Jakes 2",
        "Kaelyssa 1", "Kallus 1", "Kallus 2", "Karchev 1", "Kaya 1", "Kaya 2", 
        "King of Nothing 1", "Kozlov 1", 
        ...
        "Makeda 3", "Malakov 2", "Malekus 1", "Midas 1", "Mohsar 1", "Montador 1", 
        ...
        "Strakhov 1", "Strakhov 2", "Stryker 1", "Stryker 2", "Stryker 3", 
        "Sturgis 1", "Sturgis 2",
    ...
    if (!all(x %in% casters)) {
        ...
        # Durgen
        x <- str_replace(pattern = "^Madhammer 1$", string = x, replacement = "Durgen 1")
