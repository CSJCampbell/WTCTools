...
#' Update statline matrix using data.
#' 
...
#' player1, player2, result, list1, list2, and statline columns
...
updateStatline <- function(data, status = NULL, pairlookup = NULL, pairs = NULL, 
