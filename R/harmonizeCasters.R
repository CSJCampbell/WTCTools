...
#' @examples harmonizeCasters(c("Vlad", "Vlad1", "Vald 1"))
...
harmonizeCasters <- function(x) {
    casters <- c("Absylonia 1", "Absylonia 2", "Agathia 1", "Amon 1", "Arkadius 1", 
        ...
        "Blaize 1", "Borka 1", "Borka 2", "Bradigus 1", "Butcher 1", 
        "Butcher 2", "Butcher 3", "Caine 1", "Caine 2", "Caine 3", "Calaban 1", 
        "Calandra 1", "Carver 1", "Cyphon 1", "Damiano 1", "Darius 1", 
        "Deneghra 1", "Deneghra 2", "Deneghra 3", "Doomshaper 1", "Doomshaper 2", 
        "Doomshaper 3", "Durgen 1", "Durst 1", "Feora 1", "Feora 2", 
        "Fiona 1", "Garryth 1", "Goreshade 1", "Goreshade 2", "Goreshade 3", 
        ...
        "Helynna 1", "Hexeris 1", "Hexeris 2", "High Reclaimer 1", "High Reclaimer 2", 
        "Iron Mother 1", "Irusk 1", "Irusk 2", "Issyria 1", "Jaga-Jaga 1", 
        "Kaelyssa 1", "Kallus 1", "Karchev 1", "Kaya 1", "Kaya 2", "Kozlov 1", 
        ...
        "Madrak 2", "Maelok 1", "Magnus 1", "Magnus 2", "Makeda 1", "Makeda 2", 
        ...
        "Strakhov 1", "Stryker 1", "Stryker 2", "Stryker 3", "Sturgis 1", 
        "Sturm & Drang 1", "Syntherion 1", "Tanith 1", "Terminus 1", 
        "Thagrosh 1", "Thagrosh 2", "Thexus 1", "Thyra 1", "Thyron 1", 
        "Vayl 1", "Vayl 2", "Venethrax 1", "Vindictus 1", "Vladimir 1", 
        "Vladimir 2", "Vladimir 3", "Vyros 1", "Vyros 2", "Wurmwood 1", 
        "Xekaar 1", "Xerxis 1", "Xerxis 2", "Zaal 1", "Zaal 2", "Zerkova 1", 
        "Zerkova 2")
    ...
    if (!all(x %in% casters)) {
        ...
        # Saeryn
        x <- str_replace(pattern = "^(Saeryn 2)|(Saeryn & Rhyas [12])$", string = x, replacement = "Saeryn 2 & Rhyas 2")
        # Amon
